...
Game.prototype.introOutro = function (scenario, creature) {
  ...
  if (scenario === 'intro') {
    ...
    text = `You have died. You managed to make it to level ${this.player.level}. On your way you killed ${this.player.kills} creatures but overall met your fate on cave floor ${this.currentLevel} fighting a ${creature}. Do you want to play again?`
  }
  let x = 0
