...
/***/ function(module, exports, __webpack_require__) {
	...
	const Item = __webpack_require__(7)
	...
	Game.prototype.introOutro = function (scenario, creature) {
	  ...
	  let text;
	  if (scenario === 'intro') {
	    text = "It all started with a harmless adventure into the cave, but soon misfortune struck. The earth started to shake and the exit out was burried in rubble. Now the only thing left to do is to try to find another way out...                        or die.                   Use the arrow keys to move around."
	  } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Character = __webpack_require__(5);
	const Item = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Weapon = __webpack_require__(6);
